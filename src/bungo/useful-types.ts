export { RequiredProps, OptionalProps } from "@romejs/typescript-helpers/index";

// Copyright Shopify Inc.
// MIT License
// from https://github.com/Shopify/quilt/blob/master/packages/useful-types/src/types.ts
